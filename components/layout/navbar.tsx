...
import { generateCatalogPDF, type CatalogPdfProduct } from "@/lib/pdf-generator";
import { cn } from "@/lib/utils";
import type { MachineToolCategory } from "@/lib/sanity/types";

const Navbar = ({ categories = [] }: { categories?: MachineToolCategory[] }) => {
  ...
  // Default categories if none from props
  ...
  const handleDownloadCatalog = async () => {
    ...
    try {
      ...
      const data = (await response.json()) as { products?: CatalogPdfProduct[] };
